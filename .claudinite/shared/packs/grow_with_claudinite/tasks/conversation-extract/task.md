...
The standing log is the issue titled exactly, in this repo:

> **Claudinite tracker: Conversation Extract**
...
log it as a **dated comment** — not a sub-issue — so the issue accumulates a scrollable history, each entry
naming **what was added and where**.
